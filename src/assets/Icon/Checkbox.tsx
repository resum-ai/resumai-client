...
export const Checkbox = ({ isChecked, handleChatClick }: CheckboxProps) => {
  return (
    <div onClick={handleChatClick} css={checkboxStyle}>
      {isChecked ? (
        <svg
          width="24"
          height="24"
          ...
          <rect x="1" y="1" width="22" height="22" rx="6" fill="#0C81E4" />
          <path
